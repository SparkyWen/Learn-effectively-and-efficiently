...
class App(tk.Tk):
    ...
    def _build_ui(self):
        ...
        self.headers_text = tk.Text(frm_hdr, height=8, wrap="word")  # 19列更高一点，逻辑不变
    ...
    def _load_cfg(self):
        try:
            ...
            if cfgp.exists():
                ...
                # ✅ 修改：默认值从旧 5 列改为 19 列
                self.headers_text.insert("1.0", cfg.get("headers_text", DEFAULT_HEADERS_TEXT))
        except Exception:
            pass
